...
<!-- 2번째 메인 -->
<%
List myReviewList2 = (List)request.getAttribute("myReviewList");
...
%>
	...
	<td><input type="button" value="리뷰삭제" class="writeReview" onclick="location.href='./ReviewDelete.re?review_num=<%=rb.getReview_num()%>'"></td></tr>
<%		}
	}
	 %>
